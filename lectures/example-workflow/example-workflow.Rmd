...
.center[<img src="GenErode_illustration.jpg"/>]
...
* Started at Snakemake version 3.10 (!), current pipeline runs with Snakemake version 6.12.1
...
* Cluster execution (e.g. UPPMAX) with slurm: 
    * `config/cluster.yaml` file to set up slurm profile
