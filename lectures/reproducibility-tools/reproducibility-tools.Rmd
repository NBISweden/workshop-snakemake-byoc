...
* The workflow is run in Snakemake until a rule to run the foreign workflow
  is reached, in which Snakemake .green[hands over] to the other workflow management system 
