...
* Write an environment file (`environment.yaml`) that includes **all tools used by the workflow** (see [best practice example](https://github.com/NBISweden/snakemake_best_practice)):
