...
* You can ask Snakemake questions to everyone in .green[Snakemake issues]

* Each group has their own discussion, too (.green[Group 1], .green[Group 2], .green[Group 3], .green[Group 4])
...
Whenever we open the breakout rooms, please move yourselves into your group room (except for group 2 who stays with Verena in the main room)

.green[Group 1: Erik F.]
* Yueqing, Marti, Juanita, Nina

.green[Group 2: Verena]
* Nima, Andreas, Hao
